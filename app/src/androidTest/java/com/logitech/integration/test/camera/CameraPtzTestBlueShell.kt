...
class CameraPtzTestBlueShell(
        ...
        fun data(): Collection<Array<Any>> {
            return listOf(
                arrayOf(
                    30,
                    true,
                    VideoSize.VID_640_480,
                    MediaRecorder.VideoEncoder.H264,
                    MediaRecorder.AudioEncoder.AAC,
                    600000,
                    MediaRecorder.OutputFormat.MPEG_4
                )
                //arrayOf(30, true, VideoSize.VID_640_480, MediaRecorder.VideoEncoder.HEVC, MediaRecorder.AudioEncoder.AAC, 600000, MediaRecorder.OutputFormat.MPEG_4)
    ...
    fun paramToCameraSettting(): CameraSettings {
        ...
        return CameraSettings(
            fps, CAMERA.MAIN_CAMERA.cameraId, videoSize.point, CameraRecordOptions(
                outputFile,
                videoEncoding,
                audioEncoding,
                videoBitRate,
    ...
    fun cameraTest(){
        ...
        blueShellRule.blockingWithPtzDevice({ ptzDevice, ptzServiceHelper ->
            ...
            //accessing provider query parameter
            //Uri.parse("content://com.logitech.test.support/xxx" ),null, null, null, null);
...
/*            ptzDevice.applyMovementAndAssert(
        ...
        logger.info("KONGINTEGRATION - starting enc dec.. outPut stored? ${blueShellRule.checkFileStatus(outputFile)} with size: ${(outputFile!!.length())}")
