...
class EncoderTest(
    private val mInputFile: String,
    private val mMime: String,
    private val mBitRate: Int,
    private val mWidth: Int,
    private val mHeight: Int,
    private val mIFrameInterval: Int,
    private val mProfile: Int,
    private val mLevel: Int,
    private val mSampleRate: Int,
    private val mNumChannel: Int
) {
    @Test
...
/* 600 Kbps *//*
        ...
        private val ENCODE_DEFAULT_AUDIO_BIT_RATE = 128000 */
/* 128 Kbps */

        private var mColorFormat = CodecCapabilities.COLOR_FormatYUV420Flexible
        ...
        @JvmStatic
        fun inputFiles(): Collection<Array<Any>> {
        ...
        fun prepareInput() {
            ...
            var status = decodeFile(mInputFilePath + DECODE_FULLHD_INPUT, mDecodedFileFullHd)
